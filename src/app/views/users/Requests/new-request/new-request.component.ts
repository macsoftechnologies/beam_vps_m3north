...
private groupByModule(data: any[], displayProperty: string): any[] {
  ...
  toggleNightShift(isChecked: boolean) {
  this.isnightshiftyes = isChecked;
  this.RequestForm.get('night_shift').setValue(isChecked ? 1 : '');
    ...
    if (this.selectedbuilding == '13') {
      ...
      switch (event) {
        ...
        case "MU91.2":
          ...
          this.blocks = [
            { name: "SecondFloor", pdfSrc: "assets/images/plans/MU91/MU91.2/MU91.2F.pdf", className: 'SecondFloor', planType: 'MU91.2' },
        ...
        case "MU91.3":
          ...
          this.blocks = [
            { name: "ThirdFloor", pdfSrc: "assets/images/plans/MU91/MU91.3/MU91.3F.pdf", className: 'ThirdFloor', planType: 'MU91.3' },
        ...
        case "MU91.4":
          ...
          this.blocks = [
            { name: "FourthFloor", pdfSrc: "assets/images/plans/MU91/MU91.4/MU91.4F.pdf", className: 'FourthFloor', planType: 'MU91.4' },
...
this.RequestForm.controls["mechanical_works"].setValue(mechanicalIds);
    ...
    if (data["Room_Type"] && data["Room_Nos"]) {
        ...
        if (selectFloorBlocks) {
            let zoneSubList = [];
            let roomNos = data['Room_Nos'].split(',').map(r => r.trim());
    ...
    // Handle night shift
    const nightShiftValue = data["night_shift"] == "1" ? 1 : '';
    this.RequestForm.controls["night_shift"].setValue(nightShiftValue);
    this.isnightshiftyes = nightShiftValue === 1;
